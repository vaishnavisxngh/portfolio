...
Command: npx gltfjsx@6.5.3 public/models/window.glb --shadows --resolution 512 --keepmeshes --instance --types --output app/components/models/Window.tsx 
Files: public/models/window.glb [38.44KB] > C:\Users\KIIT0001\Desktop\p\app\components\models\window-transformed.glb [38.25KB] (0%)
...
const Window = (props: Partial<THREE.Object3D>) => {
